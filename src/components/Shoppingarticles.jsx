...
export default function Shoppingarticles() {
  return (
    <div class='shoppcard'>
        <div class="headershoppingcarte">
            <h2>SHOPPING CART</h2>
            <div>close<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
